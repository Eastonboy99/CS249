...
public class Person implements Serializable {
    ...
    /**
     * Precondition: newDate is a consistent date of birth. Postcondition: Date of
     * birth of the calling object is newDate.
     */
    ...
    /**
     * Precondition: newDate is a consistent date of death. Postcondition: Date of
     * death of the calling object is newDate.
     */
    ...
    /**
     * Precondition: The date of birth has been set, and changing the year part of
     * the date of birth will give a consistent date of birth. Postcondition: The
     * year of birth is (changed to) newYear.
     */
    ...
    /**
     * Precondition: The date of death has been set, and changing the year part of
     * the date of death will give a consistent date of death. Postcondition: The
     * year of death is (changed to) newYear.
     */
    ...
    /**
     * To be consistent, birthDate must not be null. If there is no date of death
     * (deathDate == null), that is consistent with any birthDate. Otherwise, the
     * birthDate must come before or be equal to the deathDate.
     */
